  ...
  return (
    <main className="min-h-screen bg-[#f4f6f2] px-5 py-8 text-[#10251c] md:px-10">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 overflow-hidden rounded-[2rem] bg-white ring-1 ring-black/5">
          {transactions.length === 0 ? (
            <p className="p-10 text-center text-[#6e857a]">
            ...
            transactions.map((transaction) => (
              <article
                key={transaction.id}
                className="border-b border-black/6 p-6 last:border-0 md:flex md:items-start md:justify-between"
              >
                <div>
                  <p className="text-xs font-bold uppercase tracking-[.14em] text-[#85ae38]">
                    {transaction.eventType.replaceAll('_', ' ')}
                  </p>
                ...
                <div className="mt-4 space-y-2 md:mt-0 md:min-w-56">
